...
import nfp  # isort:skip    # custom package to provide special functionality for feature preprocessing
...
def atom_featurizer(atom):
    ...
    Creates a string hash that uniquely represents the properties of the atom.
    Contains element symbol, radical electrons, formal charge, chiral tag, aromaticity, ring size, degree, and number of hydrogens.
    """
...
def bond_featurizer(bond, flipped=False):
    ...
    Creates a string hash that uniquely represents the properties of the bond.
    Contains the symbols of the atoms it connects, the bond type, and whether it is part of a ring.
    flipped: bool, allows flipping the direction of the bond, e.g. for non-directional bonds.
    """
...
# generates a instance of the SmilesBondIndexPreprocessor from the nfp package
# uses the atom_featurizer and bond_featurizer functions to generate a format suitable for model input from SMILES strings
